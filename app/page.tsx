  ...
  const translations = {
    vi: {
      ...
      about: {
        ...
        mainQuote: "Transforming vision into reality turning intent into results",
        social: [
              ...
              <div className="animate-fade-in">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                    ...
                    <div className="group relative">
                      ...
                      <div className="relative bg-gradient-to-br from-gray-900/90 via-black/80 to-gray-900/90 backdrop-blur-xl border border-white/10 rounded-2xl p-6 sm:p-8 hover:border-[#00ff88]/30 transition-all duration-500 hover:scale-[1.02]">
                        ...
                        <div className="flex items-center gap-4 mb-6">
                          ...
                          <div>
                            <h3 className="text-xl sm:text-2xl font-bold text-white mb-1" dangerouslySetInnerHTML={{ __html: t.about.name }}></h3>
                            <p className="text-[#00ff88] font-medium text-sm">Financial Technology Student</p>
                          </div>
                        </div>

                        {/* Social Links */}
                        <div className="space-y-3">
                          <h4 className="text-white font-semibold text-sm uppercase tracking-wider mb-4">Connect With Me</h4>
                          <div className="grid grid-cols-2 gap-3">
                            {t.about.social.map((social, index) => (
                              <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center gap-3 p-3 rounded-xl bg-gradient-to-r from-white/5 to-white/10 border border-white/10 hover:border-[#00ff88]/30 transition-all duration-300 group"
                              >
                                <div className="w-8 h-8 bg-gradient-to-br from-[#00ff88] to-[#00d4ff] rounded-lg flex items-center justify-center">
                                  <span className="text-white font-bold text-xs">{social.icon}</span>
                                </div>
                                <span className="text-gray-300 text-sm group-hover:text-white transition-colors">{social.name}</span>
                              </a>
                            ))}
                          </div>
                        </div>
                    ...
                    <div className="group relative">
                      ...
                      <div className="relative bg-gradient-to-br from-gray-900/90 via-black/80 to-gray-900/90 backdrop-blur-xl border border-white/10 rounded-2xl p-6 sm:p-8 hover:border-[#00d4ff]/30 transition-all duration-500 hover:scale-[1.02]">
                        <div className="text-center">
                          ...
                          <p className="text-lg sm:text-xl md:text-2xl text-white leading-relaxed font-light italic mb-4">
                            {t.about.mainQuote}
                          </p>
                          <div className="mb-4">
                            <span className="text-4xl text-[#00d4ff]">"</span>
                          </div>
                          <div className="w-16 h-px bg-gradient-to-r from-[#00d4ff] to-[#7c3aed] mx-auto"></div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-8">
                    ...
                    {/* Description Card */}
                    <div className="group relative">
                      <div className="absolute -inset-1 bg-gradient-to-r from-[#7c3aed] via-[#00ff88] to-[#00d4ff] rounded-2xl blur opacity-25 group-hover:opacity-40 transition-opacity duration-500"></div>
                      <div className="relative bg-gradient-to-br from-gray-900/90 via-black/80 to-gray-900/90 backdrop-blur-xl border border-white/10 rounded-2xl p-6 sm:p-8 hover:border-[#7c3aed]/30 transition-all duration-500 hover:scale-[1.02]">
                        
                        <div className="mb-6">
                          <h3 className="text-xl sm:text-2xl font-bold text-white mb-4">About Me</h3>
                        ...
                        <div className="space-y-4">
                          <h4 className="text-white font-semibold text-lg">Key Expertise</h4>
                          <div className="grid grid-cols-2 gap-3">
                            {[
                              { name: "Product Management", icon: "📊", color: "from-[#00ff88] to-[#00d4ff]" },
                              { name: "Data Analytics", icon: "📈", color: "from-[#00d4ff] to-[#7c3aed]" },
                              { name: "Python & SQL", icon: "🐍", color: "from-[#7c3aed] to-[#00ff88]" },
                              { name: "Business Research", icon: "🔍", color: "from-[#00ff88] to-[#7c3aed]" }
                            ].map((skill, index) => (
                              <div key={index} className="flex items-center gap-3 p-3 rounded-xl bg-gradient-to-r from-white/5 to-white/10 border border-white/10 hover:border-[#00ff88]/30 transition-all duration-300 group">
                                <div className={`w-8 h-8 bg-gradient-to-br ${skill.color} rounded-lg flex items-center justify-center`}>
