...
import { Mail, Phone, MapPin, Calendar, ExternalLink, ChevronDown, ChevronUp } from "lucide-react"
...
export default function Sidebar({ translations, activeSection, onSectionChange }: SidebarProps) {
  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-80 bg-gradient-to-br from-[#0a0a0a] via-[#1a1a1a] to-[#0a0a0a] border-r border-[#00ff88]/20 shadow-2xl shadow-[#00ff88]/10 z-40 overflow-y-auto hidden lg:block">
