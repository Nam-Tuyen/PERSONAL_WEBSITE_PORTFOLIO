...
export default function PortfolioLayout({ 
  ...
  const professionalNavItems = [
    ...
    { 
      key: "certifications", 
      label: t?.sections?.certifications || "Certifications & Awards",
      icon: Trophy,
      color: "text-[#00ff88]",
      bgColor: "bg-[#00ff88]/10"
    },
    { 
      key: "experience", 
      label: t?.sections?.experience || "Working Experience",
      icon: Building,
      color: "text-[#00d4ff]",
      bgColor: "bg-[#00d4ff]/10"
    },
  ...
  return (
    <div className="min-h-screen bg-[#0b1220] text-white">
      {/* Fixed Header */}
      <header className="fixed inset-x-0 top-0 z-50 h-14 px-4 flex items-center justify-between bg-black/50 backdrop-blur border-b border-white/10">
        <button 
      ...
      <div className="pt-14 md:pt-0 relative md:flex">
        {/* Sidebar */}
        <aside className={[
          "fixed md:static inset-y-0 left-0 z-40 w-72",
          "bg-gradient-to-br from-gray-900/95 to-gray-800/95 backdrop-blur-xl border-r border-[#00ff88]/20 overflow-y-auto",
        ...
        <main
          ...
          className={[
            "relative min-h-[calc(100vh-3.5rem)] w-full transition-[margin] duration-300",
            open ? "ml-72" : "ml-0",
            "md:ml-72",
          ].join(" ")}
        >
