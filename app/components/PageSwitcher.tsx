...
export default function PageSwitcher({ translations, language, isSidebarCollapsed = true }: PageSwitcherProps) {
  ...
  return (
    <>
      ...
      {/* Modern LED Navigation - Tech style with animated borders */}
      <div className="fixed top-0 left-0 right-0 z-50 flex justify-center items-center h-16">
        <div className="relative bg-black/20 backdrop-blur-xl border border-white/10 rounded-2xl p-1 shadow-2xl">
          {/* Animated LED Border */}
          ...
          <div className="relative flex gap-1 justify-center items-center p-1">
            {/* Professional Page Button */}
            <button
              onClick={() => handlePageSwitch('professional')}
              className={`relative flex items-center space-x-2 px-5 py-3 rounded-xl transition-all duration-300 text-sm font-semibold ${
                isProfessionalPage
            ...
            >
              ...
              {isProfessionalPage && (
                <div className="absolute -top-1 -right-1 w-3 h-3 bg-gradient-to-r from-[#00ff88] to-[#00d4ff] rounded-full animate-pulse shadow-lg shadow-[#00ff88]/60">
            ...
            >
              ...
              {isPersonalPage && (
                <div className="absolute -top-1 -right-1 w-3 h-3 bg-gradient-to-r from-[#7c3aed] to-[#00ff88] rounded-full animate-pulse shadow-lg shadow-[#7c3aed]/60">
