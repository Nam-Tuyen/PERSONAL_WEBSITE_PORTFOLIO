...
export default function Body({ activeSection, translations, isSidebarCollapsed = false }: BodyProps) {
  ...
  return (
    <main className="relative z-10">
      ...
      {activeSection === "professional" && (
        <>
          {/* Modern Hero Section */}
          <section className={`min-h-screen flex items-center justify-center pt-20 relative overflow-hidden transition-all duration-500 ${
            isSidebarCollapsed ? 'pl-6' : 'pl-6 lg:pl-0'
          }`}>
